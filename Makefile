...
TOPLEVEL_CONFIGURE_ARGUMENTS=./configure --disable-intl

tooldir = ${exec_prefix}/x86_64-apple-darwin17.7.0
build_tooldir = ${exec_prefix}/x86_64-apple-darwin17.7.0
...
BUILD_SUBDIR = build-x86_64-apple-darwin17.7.0
# This is set by the configure script to the arguments to use when configuring
# directories built for the build system.
BUILD_CONFIGARGS =  --cache-file=./config.cache '--disable-intl' --program-transform-name='s,y,y,' --disable-option-checking --with-build-subdir="$(BUILD_SUBDIR)"
...
SUBDIRS =  libiberty opcodes bfd readline zlib libdecnumber binutils gdb etc
TARGET_CONFIGDIRS = 
# This is set by the configure script to the arguments to use when configuring
# directories built for the host system.
HOST_CONFIGARGS =  --cache-file=./config.cache  '--disable-intl' --program-transform-name='s,y,y,' --disable-option-checking
...
TARGET_SUBDIR = x86_64-apple-darwin17.7.0
# This is set by the configure script to the arguments to use when configuring
# directories built for the target.
TARGET_CONFIGARGS = --cache-file=./config.cache --enable-multilib   '--disable-intl' --program-transform-name='s,y,y,' --disable-option-checking --with-target-subdir="$(TARGET_SUBDIR)"
# This is the list of variables to export in the environment when
